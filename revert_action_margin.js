...
const targetRegExp = /<div class="tt-card-rating" style="margin-bottom: 5px; color: #d4af37; display: flex; align-items: center; justify-content: center; gap: 2px;">/g;
const replacement = `<div class="tt-card-rating" style="margin-bottom: 12px; color: #d4af37; display: flex; align-items: center; justify-content: center; gap: 2px;">`;
