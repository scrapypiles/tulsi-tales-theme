...
css += `
.ayus-accordion-content, 
.ayus-accordion-content *, 
.ayus-accordion-content p, 
.ayus-accordion-content div, 
.ayus-accordion-content span, 
.ayus-accordion-content ul, 
.ayus-accordion-content li {
...
const req = https.request({
  ...
  res.on('end', () => console.log('Forced Accordion Line height deployed.'));
});
req.write(putData);
req.end();
