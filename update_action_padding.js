...
const targetRegExp = /<div class="tt-card-action" style="padding: 10px 0 0 0; margin-top: auto; display: flex; flex-direction: column; width: 100%; align-items: center;">/g;
const replacement = `<div class="tt-card-action" style="padding: 5px 0 0 0; margin-top: auto; display: flex; flex-direction: column; width: 100%; align-items: center;">`;
